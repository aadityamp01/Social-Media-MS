...
/*Steps to follow when creating a JDBC connections
	...
	public static void main(String[] args) throws Exception{
		...
		while(flag) {
			...
			case 3:
				...
				int pincode;
				System.out.println("enter user email id ");    Emailid=inp.next();  ((PreparedStatement) std).setString(1,Emailid);
				System.out.println("enter user 10 digit phone no ");    phoneno=inp.next();   ((PreparedStatement) std).setString(2,phoneno);
				System.out.println("enter user password ");    Password=inp.next();    ((PreparedStatement) std).setString(3,Password);
				System.out.println("enter user first name ");    firstname=inp.next();   ((PreparedStatement) std).setString(4,firstname);
				System.out.println("enter user last name ");    lastname=inp.next();   ((PreparedStatement) std).setString(5,lastname);
				System.out.println("enter user city ");    city=inp.next();    ((PreparedStatement) std).setString(6,city);
				System.out.println("enter user pincode ");    pincode=inp.nextInt();  ((PreparedStatement) std).setInt(7,pincode);
				System.out.println("enter user date of birth in yyyy-mm-dd format ");    dob=inp.next();  ((PreparedStatement) std).setString(8,dob);
				System.out.println("enter user gender 'M' or 'F' ");    gender=inp.next(); ((PreparedStatement) std).setString(9,gender);
