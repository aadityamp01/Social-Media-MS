insert into users (Email_ID,Phone_No,Pass_word,First_name,Last_name,City,PinCode,DOB,Gender) values ('dfsk@gmail.com','7895546456','afas','aaditya','sddflk','Pune',487645,DATE '2001-04-19','M');
insert into users (Email_ID,Phone_No,Pass_word,First_name,Last_name,City,PinCode,DOB,Gender) values ('sfgdfg@gmail.com','9795546456','fkdj','kedar','greg','Kolkata',789645,DATE '2000-10-17','M');
insert into users (Email_ID,Phone_No,Pass_word,First_name,Last_name,City,PinCode,DOB,Gender) values ('rtwrt@gmail.com','9725546456','sfgks','pratik','retgr','Nashik',456645,DATE '2004-05-22','M');
insert into users (Email_ID,Phone_No,Pass_word,First_name,Last_name,City,PinCode,DOB,Gender) values ('hkfhf@gmail.com','9745546456','rwee','navin','lrrwg','Bhopal',16645,DATE '2000-02-02','M');
insert into users (Email_ID,Phone_No,Pass_word,First_name,Last_name,City,PinCode,DOB,Gender) values ('rqwerw@gmail.com','9785546456','yjgdhf','disha','lkdfh','Delhi',798645,DATE '2005-12-15','F');
select * from users;
